...
exports.signup = async (req, res, next) => {
    try {
        ...
        if (username && email && password) {
            ...
            const msg = 'Welcome to the Uptimedown, <br /> please click on this link to validate and activate your account - <a href="' + siteURL + '/accounts/validate/' + token + '">Activate account</a> <br /> Uptimedown <br /> Web: https://uptimedown.net <br /> Email: dejan.dvte@gmail.com';
