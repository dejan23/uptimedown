...
exports.createCheck = async (req, res, next) => {
  try {
    ...
    const timeoutSeconds = typeof (parseInt(req.body.timeoutSeconds)) == 'number' && parseInt(req.body.timeoutSeconds) % 1 === 0 && parseInt(req.body.timeoutSeconds) >= 1 && parseInt(req.body.timeoutSeconds) <= 120 ? parseInt(req.body.timeoutSeconds) : false;
